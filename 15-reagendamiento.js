  ...
  if (esAdmin) {
    ...
    bloquesAdmin = `
      ...
      <div class="kpis" style="margin-bottom:20px;">
        ...
        <div class="kpi-card ${dashReag.pct_contactabilidad >= 85 ? 'exito' : 'alerta'}" title="Casos contactados (${dashReag.contactados} de ${dashReag.contactados + dashReag.no_contactados} trabajados) — meta 85%"><div class="valor">${dashReag.pct_contactabilidad}%</div><div class="etiqueta">% Contactabilidad</div></div>
